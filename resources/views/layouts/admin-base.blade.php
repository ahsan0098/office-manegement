               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            {{-- <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('department') }}" class="nav-link">
                                        <i class="bi bi-file-earmark-code-fill nav-icon"></i>
                                        <p>Development</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('department', ['dep' => 'management']) }}"
                                        class="nav-link active">
                                        <i class="bi bi-pc-display-horizontal nav-icon"></i>
                                        <p>Mangement</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('department', ['dep' => 'marketing']) }}" class="nav-link">
                                        <i class="bi bi-megaphone-fill nav-icon"></i>
                                        <p>Marketing</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('department', ['dep' => 'seo']) }}" class="nav-link">
